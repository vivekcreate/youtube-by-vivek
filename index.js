...
async function display(){
    showVideosByParam('popular');
}

display();


async function showVideosByParam(query) {

    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}%20videos&key=AIzaSyA00OxUbfdfVAjHn-9l48s0t-n_j7CBbNs&maxResults=25`);
